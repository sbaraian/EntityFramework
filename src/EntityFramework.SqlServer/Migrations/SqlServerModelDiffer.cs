...
namespace Microsoft.Data.Entity.SqlServer.Migrations
{
    public class SqlServerModelDiffer : ModelDiffer, ISqlServerModelDiffer
    {
        ...
        private SqlServerValueGenerationStrategy? GetValueGenerationStrategy(IProperty property) => ReadOnlySqlServerModelExtensions.GetSqlServerValueGenerationStrategy(property);
