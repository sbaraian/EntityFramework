    ...
    public class BuiltInDataTypesSqlServerFixture : BuiltInDataTypesFixtureBase<SqlServerTestStore>
    {
        ...
        public override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BuiltInNonNullableDataTypes>(b =>
                {
                    b.Property(dt => dt.Id).GenerateValueOnAdd(false).Metadata.RemoveAnnotation(new Annotation(SqlServerAnnotationNames.Prefix + SqlServerAnnotationNames.ValueGeneration, "_"));
